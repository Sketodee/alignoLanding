    ...
    <footer className="bg-black text-white border-t border-gray-800">
      <div className="w-[95%] lg:w-[90%] mx-auto py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-medium">Aligno</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Why Aligno</a></li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">© 2025 Aligno All rights reserved</p>
