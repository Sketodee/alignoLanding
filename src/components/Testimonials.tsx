        ...
        <div className="overflow-hidden">
          ...
          >
            {extendedTestimonials.map((testimonial, index) => (
              ...
              >
                <div className="h-[700px] relative overflow-hidden rounded-3xl">
                  {/* Image */}
                  <img
                  ...
                  {/* Content */}
                  <div className="absolute flex flex-col justify-between bottom-0 left-0 right-0 h-[35%] bg-transparent p-4 text-gray-300">
...
//                         <h3 className="text-2xl xl:text-3xl font-regular mb-2">Aligno transformed our project management efficiency</h3>
//                         <div>
