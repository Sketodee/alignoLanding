...
const TestimonialContent: React.FC = () => {
  const testimonials: Testimonial[] = [
    ...
    {
      id: 5,
      text: "We love how easy it is to customize Aligno for our specific needs.",
      name: "Isabella White",
    ...
    {
      id: 6,
      text: "Aligno's user-friendly interface helped our team get started quickly, no learning curve!",
      name: "Olivia Turner",
      company: "DesignHub",
